    ...
    <label class="block">
        ...
        <div class="flex rounded-md border border-gray-300 shadow-sm">
            ...
            <input {{ $attributes->except(['v-if', 'v-show', 'class'])->class([
                'bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-300 block w-full border-0 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed',
